...
public class GenericUtils {
	...
	public static String extrairTexto(String limitadorTexto, String textoOriginal) {
		String textoExtraido = "";
		
		int limiteInicial = textoOriginal.indexOf(limitadorTexto);
		
		for (int i = (limiteInicial + 1); i < textoOriginal.length(); i++) {
			if (!textoOriginal.substring(i, (i+1)).equals(limitadorTexto)) {
				textoExtraido = textoExtraido.concat(textoOriginal.substring(i, (i+1)));
			} else {
				break;
			}
		}
